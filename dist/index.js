...
exports.OrderSchema = exports.productsSchema = void 0;
...
//     },
// });
const Product = (0, mongoose_1.model)("Product", exports.productsSchema);
const bestProduct = (0, mongoose_1.model)("bestProduct", exports.productsSchema);
...
app.get("/best-products", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
